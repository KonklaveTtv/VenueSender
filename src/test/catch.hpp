...
#   if defined(CATCH_CONFIG_POSIX_SIGNALS) && defined(CATCH_CONFIG_SFS_SIG_HANDLER) && !defined(__ANDROID__)
    char* FatalConditionHandler::altStackMem = new char[sigStackSize]();
#   endif
} // namespace Catch
#else
namespace Catch {
