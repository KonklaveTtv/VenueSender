...
public:
    ...
    enum class MessageType {
		...
		// Green
			...
			BOOKING_TEMPLATE_ATTACHMENTS_CLEARED_MESSAGE,
		...
		// Orange
			...
			CLEAR_EMAILS_CONFIRMATION_MESSAGE,

			// Template
    		LOAD_TEMPLATE_CONFIRMATION_MESSAGE,
    		ENTER_SAVED_TEMPLATE_INDEX_MESSAGE,
    		SAVE_TEMPLATE_CONFIRMATION_MESSAGE,
		    ENTER_TEMPLATE_NAME_MESSAGE,
			ENTER_PRESS_QUOTE_MESSAGE,
			ENTER_QUOTE_SOURCE_MESSAGE,
			ADD_ANOTHER_QUOTE_MESSAGE,
