...
% Font
\usepackage{fontspec}
\setmainfont{Arial} % Or any other modern font like Helvetica, etc.

% Header/Footer
\pagestyle{fancy}
\fancyhf{}
\lhead{VenueSender Codebase Overview}
\rhead{\thepage}
\renewcommand{\headrulewidth}{0.4pt}
\renewcommand{\footrulewidth}{0.4pt}

% Colors
\definecolor{moderngreen}{rgb}{0.2,0.6,0.3}
\definecolor{moderndark}{rgb}{0.1,0.1,0.1}
\definecolor{modernpurple}{rgb}{0.5,0,0.6}
\definecolor{backcolour}{rgb}{0.95,0.95,0.95}

\lstdefinestyle{mystyle}{
	backgroundcolor=\color{backcolour},
	commentstyle=\color{moderngreen},
	keywordstyle=\color{moderndark},
	numberstyle=\tiny\color{moderndark},
	stringstyle=\color{modernpurple},
